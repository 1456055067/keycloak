...
impl Permission {
    ...
    #[must_use]
    pub fn implies(&self) -> Vec<Permission> {
        match self {
            Permission::RealmAdmin => vec![
                Permission::ViewRealm,
                Permission::ManageRealm,
                ...
                Permission::ViewIdentityProviders,
                Permission::ManageIdentityProviders,
                Permission::ViewEvents,
                Permission::ManageEvents,
                Permission::ViewAuthorization,
                Permission::ManageAuthorization,
            ],
            Permission::ManageRealm => vec![Permission::ViewRealm],
            Permission::ManageUsers => vec![Permission::ViewUsers],
            Permission::ManageClients => vec![Permission::ViewClients],
            Permission::ManageRoles => vec![Permission::ViewRoles],
            Permission::ManageGroups => vec![Permission::ViewGroups],
            Permission::ManageIdentityProviders => vec![Permission::ViewIdentityProviders],
            Permission::ManageEvents => vec![Permission::ViewEvents],
            Permission::ManageAuthorization => vec![Permission::ViewAuthorization],
            _ => vec![],
        }
    }
    ...
    #[must_use]
    pub fn from_role_name(role: &str) -> Option<Permission> {
        match role {
            "realm-admin" | "admin" => Some(Permission::RealmAdmin),
            "view-realm" => Some(Permission::ViewRealm),
            "manage-realm" => Some(Permission::ManageRealm),
            "view-users" => Some(Permission::ViewUsers),
            "manage-users" => Some(Permission::ManageUsers),
            "impersonation" => Some(Permission::ImpersonateUsers),
            "view-clients" => Some(Permission::ViewClients),
            "manage-clients" => Some(Permission::ManageClients),
            "view-roles" => Some(Permission::ViewRoles),
            "manage-roles" => Some(Permission::ManageRoles),
            "view-groups" => Some(Permission::ViewGroups),
            "manage-groups" => Some(Permission::ManageGroups),
            "view-identity-providers" => Some(Permission::ViewIdentityProviders),
            "manage-identity-providers" => Some(Permission::ManageIdentityProviders),
            "view-events" => Some(Permission::ViewEvents),
            "manage-events" => Some(Permission::ManageEvents),
            "view-authorization" => Some(Permission::ViewAuthorization),
            "manage-authorization" => Some(Permission::ManageAuthorization),
            _ => None,
        }
    }
    ...
    pub fn role_name(&self) -> &'static str {
        match self {
            Permission::RealmAdmin => "realm-admin",
            Permission::ViewRealm => "view-realm",
            Permission::ManageRealm => "manage-realm",
            Permission::ViewUsers => "view-users",
            Permission::ManageUsers => "manage-users",
            Permission::ImpersonateUsers => "impersonation",
            Permission::ViewClients => "view-clients",
            Permission::ManageClients => "manage-clients",
            Permission::ViewRoles => "view-roles",
            Permission::ManageRoles => "manage-roles",
            Permission::ViewGroups => "view-groups",
            Permission::ManageGroups => "manage-groups",
            Permission::ViewIdentityProviders => "view-identity-providers",
            Permission::ManageIdentityProviders => "manage-identity-providers",
            Permission::ViewEvents => "view-events",
            Permission::ManageEvents => "manage-events",
            Permission::ViewAuthorization => "view-authorization",
            Permission::ManageAuthorization => "manage-authorization",
        }
    }
}
